		...
		var TableInit = function () {
			...
			oTableInit.Init = function () {
				$('#exampleTableEvents').bootstrapTable({
					url:'${_ctx}/storeTypeAdminAction/findStoreListByPage',         //请求后台的URL（*）
					method: 'post',                      //请求方式（*）
		...
		//删除
		  $("#deleteButton").on("click", function () {
	            ...
	            if (rows.length == 0) {// rows 主要是为了判断是否选中，下面的else内容才是主要
	                ...
	                $.ajax({
						type:"post",
						url:"${_ctx}/storeTypeAdminAction/deleteTypeByIds",
						data:{"idcard":idcard},
		    ...
		    $(".saveSubmit").on("click",function(){
		    		...
		    		var url = "${_ctx}/storeTypeAdminAction/addType";
		    		if(storeType_id && storeType_id != ""){
		    			url = "${_ctx}/storeTypeAdminAction/editType";
		    		}
		    			$.ajax({
							type:"post",
							url:url,
