...
insert  into `business_comment`(`comment_id`,`comment_main`,`food_id`,`order_id`,`user_id`,`comment_data`) values ('4028b48169eb78790169eb88a2c80000','我只想说这个东西是真几把难吃','4028b481699477aa0169947ce5d60002','4028b48169aa065c0169aa1104cf0000','4028b48169a456860169a45c21b20002','2019-04-05 03:26:34'),('4028b48169ed4cbc0169ed56d8d10002','真是难吃啊。。。','4028b48169a456860169a459b1f30000','4028b48169aa065c0169aa1104e40001','4028b48169a456860169a45c21b20002','2019-04-05 11:51:26');
...
insert  into `business_staff`(`staff_id`,`create_date`,`phone`,`staffAddress`,`store_name`,`staff_position`,`store_id`) values (2,'2019-04-04 13:00:50','1318533144','武汉纺织大学','董超','垃圾工',NULL),(3,'2019-04-04 13:07:02','17671725605','武汉纺织大学','张三','外卖员','e0582f891ea742eb9fa7ac18b473def2'),(4,'2019-04-04 13:07:54','17671725601','武汉软件工厂职业','李四','厨师','e0582f891ea742eb9fa7ac18b473def2');
...
CREATE TABLE `business_stock` (
  `stock_id` varchar(125) NOT NULL,
  `stock_name` varchar(125) DEFAULT NULL,
  `stock_number` double DEFAULT NULL,
  `store_id` varchar(125) DEFAULT NULL,
  PRIMARY KEY (`stock_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `business_stock` */

insert  into `business_stock`(`stock_id`,`stock_name`,`stock_number`,`store_id`) values ('4028b48169e8b0770169e8b279f00000','卫龙',85,'e0582f891ea742eb9fa7ac18b473def2'),('4028b48169e8e3070169e91a369f0000','老干妈',200,'e0582f891ea742eb9fa7ac18b473def2');
...
insert  into `system_user`(`user_id`,`ip`,`last_login`,`name`,`password`,`role_id`,`tenant_id`,`username`,`rights`,`type_id`) values ('402880fe67c574580167c57584670000','0:0:0:0:0:0:0:1','2019-03-23 18:17:56','佘正丰','e10adc3949ba59abbe56e057f20f883e',NULL,'2d137f3ade9c4452b5566c038dfcef23','szf',101737456,NULL),('4028abc96671444a0166714529920000','0:0:0:0:0:0:0:1','2019-04-05 19:54:45','系统管理员','e10adc3949ba59abbe56e057f20f883e',NULL,NULL,'admin',15121470,NULL),('e4c05c29673bde0201673bfa558c0000','0:0:0:0:0:0:0:1','2019-04-05 19:58:30','dc','e10adc3949ba59abbe56e057f20f883e',NULL,'e0582f891ea742eb9fa7ac18b473def2','dc',101737456,NULL);
...
/*Data for the table `tutorials_tbl` */
...
insert  into `wx_user`(`user_id`,`password`,`phone`,`money`,`department`,`introduction`,`nickName`,`portrait`,`sex`) values ('4028b48169a456860169a45c21b20002','e10adc3949ba59abbe56e057f20f883e','17671725404',28200,'垃圾回收学院','我是一只小太阳','小蛮杨','http://127.0.0.1:8080/uploadImages/2019-04-05/944967aeec644434a37f4fe23785ea29.jpeg','女'),('4028b48169a45e2f0169a45fc6e50000','e10adc3949ba59abbe56e057f20f883e','17671725405',53600,NULL,NULL,NULL,NULL,NULL),('4028b48169a462600169a46370570000','e10adc3949ba59abbe56e057f20f883e','17671725409',42600,NULL,NULL,NULL,NULL,NULL),('ff80808167c972c60167c978b7eb000a','e10adc3949ba59abbe56e057f20f883e','17828895385',53600,NULL,NULL,NULL,NULL,NULL);
